...
var _user$project$App_Model$Model = F3(
	function (a, b, c) {
		return {matrices: a, matrix: b, status: c};
	});
var _user$project$App_Model$Option = F4(
	function (a, b, c, d) {
		return {id: a, key: b, value: c, sort: d};
	});
var _user$project$App_Model$Options = F4(
	function (a, b, c, d) {
		return {id: a, key: b, value: c, options: d};
	});
var _user$project$App_Model$Row = F3(
	function (a, b, c) {
		return {id: a, name: b, sort: c};
	});
var _user$project$App_Model$Col = F4(
	function (a, b, c, d) {
		return {id: a, name: b, sort: c, options: d};
	});
var _user$project$App_Model$Matrix = F5(
	function (a, b, c, d, e) {
		return {id: a, name: b, rows: c, cols: d, active: e};
	});
...
var _user$project$App_Update$SetOptionName = function (a) {
	return {ctor: 'SetOptionName', _0: a};
};
var _user$project$App_Update$SaveOption = {ctor: 'SaveOption'};
var _user$project$App_Update$OpenOption = {ctor: 'OpenOption'};
var _user$project$App_Update$OpenOptions = function (a) {
	return {ctor: 'OpenOptions', _0: a};
};
var _user$project$App_Update$SaveOptions = function (a) {
	return {ctor: 'SaveOptions', _0: a};
};
var _user$project$App_Update$SaveMatrix = {ctor: 'SaveMatrix'};
var _user$project$App_Update$AddMatrix = {ctor: 'AddMatrix'};
var _user$project$App_Update$AddCol = function (a) {
	return {ctor: 'AddCol', _0: a};
};
var _user$project$App_Update$AddRow = function (a) {
	return {ctor: 'AddRow', _0: a};
};
var _user$project$App_Update$SetColName = F2(
	function (a, b) {
		return {ctor: 'SetColName', _0: a, _1: b};
	});
var _user$project$App_Update$SetRowName = F2(
	function (a, b) {
		return {ctor: 'SetRowName', _0: a, _1: b};
	});

var _user$project$App_View$trStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'height', _1: '2em'},
		_1: {ctor: '[]'}
	});
var _user$project$App_View$colStyle = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'width', _1: '2em'},
		_1: {ctor: '[]'}
	});
var _user$project$App_View$qgrid = A2(
	_elm_lang$html$Html$table,
	{ctor: '[]'},
	{
		ctor: '::',
		_0: A2(
			_elm_lang$html$Html$colgroup,
			{ctor: '[]'},
			{
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$col,
					{
						ctor: '::',
						_0: _user$project$App_View$colStyle,
						_1: {ctor: '[]'}
					},
					{ctor: '[]'}),
				_1: {
		...
		_1: {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _user$project$App_View$trStyle,
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('bg-gold sans-serif'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('mw9 center pa4 pt5-ns ph7-l'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('f6 mb2 dib ttu tracked'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('stackable shareable matrices'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}),
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('f2 f1-m f-headline-l measure-narrow lh-title mv0'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('bg-black-90 lh-copy white pa1 tracked-tight'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('QGRID'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}),
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('f3 fw1 georgia i'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Easily aggregate group feedback in matrix style surveys & assessments.'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('pa4 ph7-l georgia mw9-l center'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('f5 f3-ns lh-copy measure georgia'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('I was on a hiring commitee once where we had to score candidates.\n                    The group emailed a spreadsheet around. This process was ineffecient and\n                    involved a lot of labor that could have been automatted. Enter the idea for qgrid.'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Let\'s try it out'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: _user$project$App_View$qgrid,
								_1: {ctor: '[]'}
							}
						}
					}),
